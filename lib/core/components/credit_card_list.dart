...
Widget creditCardList(List<DTOBucket> bucket, {Function(DTOBucket)? onTap}) {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        (bucket[index].credit_card_limit ?? 0.0).toString(),
                        overflow: TextOverflow.ellipsis,
                        style: const TextStyle(
                          color: CustomColors.LIGHT_BLACK,
                          fontFamily: "JosefinSans",
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        (bucket[index].credit_card_borrow ?? 0.0).toString(),
                        overflow: TextOverflow.ellipsis,
                        style: TextStyle(
