...
Widget borrowDropdown(
    {required Function(DTOBorrow?) onSelected, required List<DTOBorrow> items, Key? key, required DTOBorrow? value, required bool loading, double? height}) {
  return customDropdown<DTOBorrow>(
    key: key,
    prefixIcon: const Icon(Icons.wallet),
    hintText: "Borç Seçiniz",
    height: height,
    dropdownBuilder: (_, DTOBorrow? selectedItem) => Padding(
      ...
      child: loading
          ...
          : Text(
              selectedItem != null ? selectedItem.title! : "Borç Seçiniz",
