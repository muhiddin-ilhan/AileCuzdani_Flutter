...
Future<bool?> showRemoveBorsaPopup(BuildContext context, {DTOBucket? bucket}) async {
  ...
  List<Widget> getBorsaValueArea(Function(void Function()) setState) {
    return [
      const Padding(
        padding: EdgeInsets.fromLTRB(13, 10, 0, 0),
        child: Text(
        ...
        child: Dialog(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                appBar(),
                ...getBorsaCountArea(setState),
                ...getBorsaValueArea(setState),
                ...
                button(
                  ...
                  onTap: () async {
                    ...
                    bool response = await BucketServices.transferBetweenBucket(
                      money: double.tryParse(borsaValueController.text) ?? 0.0,
                      recieverBucketId: selectedBankAccount!.id!,
                      senderBucketId: bucket!.id!,
                      count: double.tryParse(borsaCountController.text) ?? 0.0,
                    );
